...
class FullBlockTest(BitcoinB3TestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure bitcoinb3d isn't accepting b26
        ...
        # Extend the b28 chain to make sure bitcoinb3d isn't accepting b28
        ...
        # bitcoinb3d doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the bitcoinb3 code has custom code which does so);
