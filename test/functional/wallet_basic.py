...
class WalletTest(BitcoinB3TestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 B3C from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 b3c in block rewards plus fees, but
        ...
        # Send 10 B3C with subtract fee from amount
        ...
        # Sendmany 10 B3C with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/bitcoinb3/bitcoinb3/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
