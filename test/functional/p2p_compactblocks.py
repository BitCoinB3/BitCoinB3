...
# TestP2PConn: A peer we use to send messages to bitcoinb3d, and store responses.
...
class CompactBlocksTest(BitcoinB3TestFramework):
    ...
    # This test actually causes bitcoinb3d to (reasonably!) disconnect us, so do this last.
    ...
    # Test that bitcoinb3d requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bitcoinb3d to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bitcoinb3d will not send blocktxn responses for blocks whose height is
