...
This document provides guidelines for internationalization of the BitcoinB3 Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoinb3_en.ts` remains unchanged.
