...
* bitcoinb3.conf: contains configuration settings for bitcoinb3d or bitcoinb3-qt
* bitcoinb3d.pid: stores the process id of bitcoinb3d while running
...
* debug.log: contains debug information and general logging generated by bitcoinb3d or bitcoinb3-qt
