...
#ifndef BITCOINB3_WALLET_WALLET_H
#define BITCOINB3_WALLET_WALLET_H
...
public:
     ...
     * on this bitcoinb3 node, and set to 0 for transactions that were created
...
#endif // BITCOINB3_WALLET_WALLET_H
