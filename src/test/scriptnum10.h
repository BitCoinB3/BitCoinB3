...
#ifndef BITCOINB3_TEST_SCRIPTNUM10_H
#define BITCOINB3_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BitcoinB3 Core 0.10.0, for cross-comparison.
 */
public:
