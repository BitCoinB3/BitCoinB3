...
{
    BOOST_CHECK(TestSplitHost("www.bitcoinb3core.org", "www.bitcoinb3core.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bitcoinb3core.org]", "www.bitcoinb3core.org", -1));
    BOOST_CHECK(TestSplitHost("www.bitcoinb3core.org:80", "www.bitcoinb3core.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcoinb3core.org]:80", "www.bitcoinb3core.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:4474", "127.0.0.1", 4474));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:4474", "127.0.0.1", 4474));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:4474", "::ffff:127.0.0.1", 4474));
    BOOST_CHECK(TestSplitHost("[::]:4474", "::", 4474));
    BOOST_CHECK(TestSplitHost("::4474", "::4474", -1));
    BOOST_CHECK(TestSplitHost(":4474", "", 4474));
    BOOST_CHECK(TestSplitHost("[]:4474", "", 4474));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:4474", "127.0.0.1:4474"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:4474", "[::]:4474"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
