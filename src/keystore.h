...
#ifndef BITCOINB3_KEYSTORE_H
#define BITCOINB3_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/bitcoinb3/bips/blob/master/bip-0013.mediawiki
