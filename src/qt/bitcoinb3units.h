...
#ifndef BITCOINB3_QT_BITCOINB3UNITS_H
#define BITCOINB3_QT_BITCOINB3UNITS_H
...
/** BitcoinB3 unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BitcoinB3Units: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BitcoinB3Units(QObject *parent);

    /** BitcoinB3 units.
      @note Source: https://en.bitcoinb3.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        B3C,
...
typedef BitcoinB3Units::Unit BitcoinB3Unit;

#endif // BITCOINB3_QT_BITCOINB3UNITS_H
