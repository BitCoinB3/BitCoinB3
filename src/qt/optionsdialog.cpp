    ...
    mapper(0)
{
    ...
    ui->bitcoinb3AtStartup->setToolTip(ui->bitcoinb3AtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->bitcoinb3AtStartup->setText(ui->bitcoinb3AtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openBitcoinB3ConfButton->setToolTip(ui->openBitcoinB3ConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new BitcoinB3Units(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitcoinb3AtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBitcoinB3ConfButton_clicked()
{
