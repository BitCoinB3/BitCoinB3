 ...
 */
#ifndef BITCOINB3_UTIL_H
#define BITCOINB3_UTIL_H
...
extern const char * const BITCOINB3_CONF_FILENAME;
extern const char * const BITCOINB3_PID_FILENAME;
...
{
    std::string s = strprintf("bitcoinb3-%s", name);
