...
static void SetupBitcoinB3TxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bitcoinb3-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bitcoinb3-tx [options] <hex-tx> [commands]  Update hex-encoded bitcoinb3 transaction\n" +
            "or:     bitcoinb3-tx [options] -create [commands]   Create hex-encoded bitcoinb3 transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcoinb3 transaction
