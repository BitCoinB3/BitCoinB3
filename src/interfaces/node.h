...
#ifndef BITCOINB3_INTERFACES_NODE_H
#define BITCOINB3_INTERFACES_NODE_H
...
//! Top-level interface for a bitcoinb3 node (bitcoinb3d process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BITCOINB3_INTERFACES_NODE_H
